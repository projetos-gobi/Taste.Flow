    ...
    <>
      ...
      {isCollapsed && (
        <Button
          ...
          className="fixed left-[64px] top-4 z-50 text-gray-700 bg-gray-200 hover:bg-gray-300 border-2 border-gray-300 rounded-md p-2 h-8 w-8 shadow-md transition-all duration-300"
          title="Expandir menu"
        >
