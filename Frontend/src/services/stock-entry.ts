...
export const createStockEntry = async (data: ICreateStockEntryRequest) => {
    const response = await api.post("/StockEntry/create-stock-entry", { ...data });

    return response.data.data;
}

export const getStockEntriesPaged = async (data: IGetStockEntriesPagedRequest) => {
    const response = await api.post("/StockEntry/get-stock-entries-paged", { ...data });

    return response.data.data;
}

export const getStockEntryById = async (data: IGetStockEntryByIdRequest) => {
    const response = await api.post("/StockEntry/get-stock-entry-by-id", { ...data });

    return response.data.data;
}

export const updateStockEntry = async (data: IUpdateStockEntryRequest) => {
    const response = await api.post("/StockEntry/update-stock-entry", { ...data });

    return response.data.data;
}

export const softDeleteStockEntry = async (data: ISoftDeleteStockEntryRequest) => {
    const response = await api.post("/StockEntry/soft-delete-stock-entry", { ...data });

    return response.data.data;
}

export const getStockValueByEnterpriseId = async () => {
    const response = await api.post("/StockEntry/get-stock-value-by-enterprise-id");
