...
export function CreateSupplierModal({
  ...
  const handleConfirm = () => {
    const hasBankPayment = paymentMethod === "PIX" || paymentMethod === "Transferência Bancária"
    const bankDataRequired = hasBankPayment && (!bankData.agency || !bankData.accountNumber || !bankData.pixKey)
    ...
    if (
      ...
      onCreateSupplier({
        ...
        bankData: hasBankPayment ? bankData : null,
      })
      handleCancel()
    }
  }
  ...
  const handleCancel = () => {
    ...
    setPhone("")
    setPaymentMethod("")
    setBankData({ agency: "", accountNumber: "", pixKey: "" })
    setCategoryId("")
    setSubcategoryId("")
    onOpenChange(false)
  }
