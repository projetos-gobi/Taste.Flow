...
ALTER TABLE [dbo].[Merchandise] WITH CHECK ADD  CONSTRAINT [FK_Merchandise_Unit_CategoryId] FOREIGN KEY([UnitId])
REFERENCES [dbo].[Unit] ([Id])
GO

ALTER TABLE [dbo].[Merchandise] CHECK CONSTRAINT [FK_Merchandise_Unit_CategoryId]
GO
